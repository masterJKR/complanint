        ...
        http.requestCache( rq -> rq.requestCache(requestCache))
                .authorizeHttpRequests(
                  ar -> ar
                          ...
                          .requestMatchers("/error","/signUp","/favicon.ico").permitAll()//  /error주소 허용
                ...
                .formLogin(
                   form -> form
                           ...
                           .usernameParameter("userId")// 로그인할때 계정명 input태그의 name
...
//  .logoutUrl("/logout")  post 요청 일경우 실행 됨 get은 안됨
        //   즉,  a 태그 통해서 요청은 get이라 안됨
